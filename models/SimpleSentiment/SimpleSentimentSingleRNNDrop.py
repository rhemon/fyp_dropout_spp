...
class SimpleSentimentSingleRNNDrop(SimpleSentimentNoDropout):
    def set_model(self, vocab_size, embedding_dim, hidden_dim, target_size, seq_len):
        ...
        blstm_layer = RNNDropAfterBLSTM(self.drop_prob, embedding_dim, hidden_dim, bidirectional=True, batch_first=True).to(self.device)
